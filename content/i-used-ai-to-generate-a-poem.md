Title: I used AI to generate a poem, this is what I got
Date: 2023-05-24 17:59
Author: chris
Category: Technology
Tags: bard, chatgpt, open ai, poetry
Slug: i-used-ai-to-generate-a-poem
Status: published
...
> <!-- wp:paragraph -->
>
> Microsoft, which has invested billions of dollars in OpenAI, soon followed with [Bing Chat](https://www.wired.com/story/microsoft-taps-chatgpt-to-boost-bing-and-beat-google/), which uses ChatGPT technology. And then, last week, Google began letting a limited number of people access [Google Bard](https://www.wired.com/story/meet-bard-googles-answer-to-chatgpt/), which is based on Google’s own technology, LaMDA, short for Language Model for Dialogue Applications.
>
> <!-- /wp:paragraph --><cite>Source: <a href="https://www.wired.com/story/review-ai-chatbots-bing-bard-chat-gpt/" target="_blank" rel="noreferrer noopener">WIRED</a></cite>
